...
namespace PresentationLayer.MainModule.UI
{
    ...
    public class ControlManager
    {
        ...
        internal void UpdateVisibleContainers(XContainer container)
        {
            ...
            {
                if (_visibleContainers.ContainsKey(container.Name + container.ParentContainer.Name))
                {
                    _visibleContainers[container.Name + container.ParentContainer.Name] = container;
                    UpdatePrevNextButton(container);//updates navigation
                }
            }
        ...
        public void UpdateBindingForVisibleContainer(XContainer container)
        {
            if (container.Name == null) return;
            ...
            {
                if (_allGroupBoxes.ContainsKey(container.Name + container.ParentContainer.Name))
                {
                    UpdateBinding(container, _allGroupBoxes[container.Name + container.ParentContainer.Name]);
        ...
        public GroupBox GetGroupBoxGui(XContainer rootContainer, XContainer rootContainerData)
        {
        ...
        private void GenerateGui(XContainer rootContainer, XContainer rootContainerData)
        {
            ...
            {
                if (_lastGroupBox.Name.Equals("requestInfo"))
                {
                    y = _lastGroupBox.Size.Height + 500;
                }
                else
                {
            ...
            if (groupBoxFromContainer.Parent == null)
            {
                _allGroupBoxes.Add(groupBoxFromContainer.Name, groupBoxFromContainer);
            }
            else
            {
                _allGroupBoxes.Add(groupBoxFromContainer.Name + groupBoxFromContainer.Parent.Name, groupBoxFromContainer);
            }
        ...
        private GroupBox GetGroupBoxFromContainer(XContainer rootContainer, XContainer rootContainerData)
        {
            ...
            {
                _visibleContainers.Add(rootContainerData.Name + rootContainerData.ParentContainer.Name+rootContainerData.Id, rootContainerData);
        ...
        private void CreateButtonClick(object sender, EventArgs e)
        {
            ...
            var visibleContainer = _visibleContainers[xContainer.Name + xContainer.ParentContainer.Name];
            ...
            _visibleContainers[xContainer.Name + xContainer.ParentContainer.Name] = container;
        ...
        {
            if (_visibleContainers.ContainsKey(container.Name + container.ParentContainer.Name) && _allGroupBoxes.ContainsKey(container.Name + container.ParentContainer.Name))
            {
                var visibleContainer = _visibleContainers[container.Name + container.ParentContainer.Name];
                var visibleGroupBox = _allGroupBoxes[container.Name + container.ParentContainer.Name];
        ...
        private void PreviousButtonClick(object sender, EventArgs e)
        {
            ...
            var container = visibleContainer.ParentContainer.Containers[index - 1];//[index - 1]
